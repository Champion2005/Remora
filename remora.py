...
#         Error.__init__(self, pos_start, pos_end, 'Illegal Character', details)

# class ExpectedCharError(Error):
#     def __init__(self, pos_start, pos_end, details):
#         Error.__init__(self, pos_start, pos_end, 'Expected Character:', details)

# class IllegalSyntaxError(Error):
#     def __init__(self, pos_start, pos_end, details):
#         Error.__init__(self, pos_start, pos_end, 'Illegal Syntax', details)

# class RuntimeError(Error):
#     def __init__(self, pos_start, pos_end, details, context):
#         Error.__init__(self, pos_start, pos_end, 'Runtime Error', details)
...
#         while self.current_char != None and (self.current_char not in "\"'" or escape_char):
#             if escape_char:
...
#     def __repr__(self):
#         return f"<Number {str(self.value)}>"
...
#                 f"{len(args)} args passed into '{self.name}'. Expected {len(self.arg_names)} args.",
#                 self.context
#             ))
...
#         isNum = isinstance(exec_ctx.symbol_table.get('value'), Number)
#         return RTResult().success(Number.true if isNum else Number.false)
#     execute_is_number.arg_names = ['value']
    
#     def execute_is_string(self, exec_ctx):
#         isString = isinstance(exec_ctx.symbol_table.get('value'), String)
...
#         isFunc = isinstance(exec_ctx.symbol_table.get('value'), BaseFunction)
...
#             return RTResult().failure(RuntimeError(
#                 self.pos_start, self.pos_end,
#                 "Second argument (index) must be number",
#                 exec_ctx
#             ))
...
# BuiltInFunction.element_at  = BuiltInFunction("element_at")
...
#     if result and result.value and result.value.elements and result.value.elements[0] == "null":
#         return "", result.error
